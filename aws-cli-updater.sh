...
AWS_EB_HOME=$CLI_FOLDER`ls $CLI_FOLDER|grep ElasticBeanstalk`"/eb/linux/python2.7/"
...
echo 'export PATH=$PATH'":$AWS_AUTO_SCALING_HOME/bin:$AWS_CLOUDFORMATION_HOME/bin:$AWS_CLOUDWATCH_HOME/bin:$EC2_API_HOME/bin:$EC2_HOME/bin:$AWS_ELB_HOME/bin:$AWS_IAM_HOME/bin:$AWS_RDS_HOME/bin:$AWS_EB_HOME">> $CLI_PROFILE
